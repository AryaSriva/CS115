...
def twoBitAdd(xxxx, yyyy, carry):
    (c, zo) = FA(xxxx[1], yyyy[1], carry)
...
def fourBitAdd(xxxx,yyyy):
    ...
    and c is the carry.'''
    firstTwo = twoBitAdd(xxxx[2:], yyyy[2:], 0)
    secondTwo = twoBitAdd(xxxx, yyyy, firstTwo[0])
    return (secondTwo[0], secondTwo[1] + firstTwo[1])
